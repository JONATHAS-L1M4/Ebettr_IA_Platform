...
import { ArrowLeft, FileQuestion, Home } from '../components/ui/Icons';
    ...
    <DarkPage className="min-h-screen">
      <div className="min-h-screen flex flex-col items-center justify-center p-4 text-center animate-fade-in">
        <div className="bg-card p-8 md:p-12 rounded-2xl shadow-sm border border-border max-w-md w-full flex flex-col items-center">
          ...
          <h2 className="text-xl font-semibold text-foreground mb-4">PÃ¡gina nÃ£o encontrada</h2>

          <p className="text-muted-foreground mb-8 leading-relaxed">
            Ops! A pÃ¡gina que vocÃª estÃ¡ procurando parece ter sido movida, excluÃ­da ou nunca existiu.
          </p>
